...
public interface FileChooser {
    /**
     * Sets the selected file, so that it appears in the textbox/searchbar and is visually
     * active in the list of files.
     */
    public void setSelectedFile(File file);
    /**
     * Gets the file that is currently selected/was selected by the user before closing the chooser window.
     */
    ...
    /**
     * Checks whether this implementation of FileChooser automatically warns the user
